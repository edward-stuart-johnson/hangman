class Hangman():
    ...
    def _insert_correctly_guessed_letter(self, guess):
        """
        This method looks through each letter in the word, finds where the correctl guessed letter is, and then replaces the relevant underscore (_) or underscores plural in the word_guessed with the correctly-guessed letter. 
